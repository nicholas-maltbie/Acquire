...
import com.flyingblock.acquire.controller.ComputerPlayerFSM.ComputerState;
 ...
 */
public class ComputerPlayerFSM extends AbstractFSM<ComputerState>
{
    /**
    ...
    /**
     * Game view, for helping the human see what's happening.
     */
     ...
     * @param view GameView
     * @param machine Machine that runs the game.
     * @param deck Deck for game.
     */
    public ComputerPlayerFSM(Decider decider, GameView view, AcquireMachine machine,
            HotelMarket deck)
    {
